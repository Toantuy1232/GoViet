        ...
        <div class="container-fluid pt-3 px-2 px-lg-3">
            <div class="bg-light rounded p-3 p-lg-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h5 class="mb-0">Thêm tour</h5>
                    <a href="IndexTourServlet" class="btn btn-outline-secondary">Quay lại</a>
                </div>
                ...
                <form method="post" action="CreateTourServlet" enctype="multipart/form-data">
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-3">
                            <label class="form-label">Số ngày (duration_days)</label>
                            <input name="duration_days" type="number" min="1" class="form-control" value="1" required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="end_date" type="datetime-local" class="form-control" required>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">Số chỗ còn trống</label>
                            <input name="available_slots" type="number" min="0" class="form-control" value="0" required>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Ảnh chính (tải lên)</label>
                    ...
                    <div class="mt-3 d-flex gap-2">
                        ...
                        <a href="IndexTourServlet" class="btn btn-outline-secondary">Hủy</a>
                    </div>
                </form>
            </div>
        </div>
