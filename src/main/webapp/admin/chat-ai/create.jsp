...
<head>
    <meta charset="utf-8">
    <title>Thêm tin nhắn - Admin</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="${pageContext.request.contextPath}/admin/chat-ai/create">
                            <div class="mb-3">
                                ...
                                <select name="senderId" class="form-select" required>
                                    ...
                                    <c:forEach items="${users}" var="user">
                                        <option value="${user.user_id}">${user.fullname} (${user.email})</option>
                                    </c:forEach>
                                </select>
                            </div>
